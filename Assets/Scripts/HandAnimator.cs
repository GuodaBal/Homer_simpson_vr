...
public class HandAnimator : MonoBehaviour
{
    ...
    public InputActionProperty triggerValueCap;
    public InputActionProperty gripValueCap;
    ...
    void Update()
    {
        float triggerTarget = triggerValue.action.ReadValue<float>();
        ...
        float gripTarget = gripValue.action.ReadValue<float>();
        ...
        //if (thumbCapTarget)
        //{
        //    thumbCap_state = Mathf.Clamp(thumbCap_state + 1 / anim_frames, 0f, 1f);
        //}
        //else
        //{
        //    thumbCap_state = Mathf.Clamp(thumbCap_state - 1 / anim_frames, 0f, 1f);
